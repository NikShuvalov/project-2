...
public class OfflineDetailActivity extends AppCompatActivity implements OfflineDetailFragment.OnFragmentClickListener, GestureDetector.OnGestureListener{
    //This arrayList exists so that I can change fragment content when user presses next/previous buttons (Will implement swipe instead if time).
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInventory = OfflineStoreInventory.getInstance().getStoreFrontInventory();
